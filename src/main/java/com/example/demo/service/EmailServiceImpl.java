...
public class EmailServiceImpl implements EmailService {
	...
	@Override
	public void processDateRange(List<StatusCodeCount> ydata,List<StatusCodeCount> data,DateTime dateTime)throws Exception {
		System.out.println("inside email service"+ ydata.toString());
	        ...
	        helper.setSubject("Sending MessageStatus report from "+formattedDate +" "+startTimeFormat+" - "+EndTimeFormat);
	        ...
	        html.append("<tr style='background-color: #FFFF99;'>")
	            .append("<th>Status Code</th>")
	            .append("<th>Yesterday Count</th>")
	            .append("<th>Today Count</th>")
	            .append("</tr>");

	        for (CombinedStatusCode entry : result) {
	            html.append("<tr>")
	                .append("<td>").append(entry.getStatusCode()).append("</td>")
	                .append("<td>").append(entry.getYesterdayCount()).append("</td>")
	                .append("<td>").append(entry.getTodayCount()).append("</td>")
	                .append("</tr>");
	        }
	...
	public void getClientsWithNoTrafficToday(CombinedAIClientResponse combinedAIClientResponse, DateTime datetime)
	        ...
	        html.append("<tr style='background-color: #FFCCCC;'>")
	        ...
	        for (CombinedClient client : data) {
	            html.append("<tr>")
	                ...
	                .append("<td>").append(client.getYesterdayCount()).append("</td>")
	                .append("<td>").append(client.getTodayCount()).append("</td>")
	                .append("</tr>");
	        }
	        html.append("</table>");
